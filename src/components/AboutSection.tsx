  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto text-center">
        <h2
          className="font-heading font-bold text-pil-black uppercase leading-[0.95] tracking-tight"
          style={{ fontSize: "clamp(2.5rem, 5vw, 4.5rem)" }}
        >
          NOMINA: More, than just
        </h2>

        <p className="text-base md:text-lg leading-relaxed text-pil-black/80 max-w-2xl mx-auto">
