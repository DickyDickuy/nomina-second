  ...
  return (
    <section id="special-20" className="bg-white px-6 md:px-12 pt-20 pb-20">
      <div className="max-w-5xl mx-auto">
        ...
        <h2
          className="font-heading font-bold text-pil-black uppercase leading-[0.92] tracking-tight"
        ...
        {/* Subtitle */}
        <h3 className="text-sm md:text-base font-bold uppercase tracking-[0.15em] text-pil-black">
          We Have Been Doing It For 20 Years
        </h3>

        {/* Description */}
        <p className="text-base md:text-lg leading-relaxed text-pil-black/80 max-w-2xl">
